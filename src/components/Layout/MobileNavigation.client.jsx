...
import MobileCountrySelector from '../elements/MobileCountrySelector.client';
  ...
  return (
    <div className="md:hidden">
      <OpenFocusTrap>
        ...
        {isOpen ? (
          <div className="fixed -left-0 top-32 w-full bg-white h-screen z-10 bg-gray-50 px-4 md:px-12 py-7">
            <ul>
              {collections.map((collection) => (
                <li className="" key={collection.id}>
                  <Link
