...
const DEFAULT_CLASSES =
  'block m-0 w-full items-center normal-case justify-center uppercase font-medium text-center px-6 py-4 rounded disabled:border-gray-300 disabled:bg-gray-300 disabled:cursor-not-allowed';

const VARIANT_CLASSES = {
  primary: 'text-white bg-primary hover:bg-gray-800 active:bg-gray-700',
  secondary:
    'text-primary bg-white hover:bg-gray-50 active:bg-gray-100 border border-primary',
};
